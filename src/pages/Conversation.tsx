...
const Conversation: React.FC = () => {
    ...
    return (
        <div className="bg-[#1a1a1a] min-h-screen flex flex-col">
            {/* Header */}
            <header className="bg-[#1a1a1a] shadow-lg sticky top-0 z-40 border-b border-gray-800">
                <div className="px-4 py-3 flex justify-between items-center">
                    <div className="flex items-center">
                        ...
                        >
                            ...
                            <div>
                                <h2 className="font-medium text-white">{matchData.name}</h2>
                                <p className="text-xs text-gray-400">{matchData.lastActive}</p>
                            </div>
                        </div>
                    </div>
            ...
            {/* Info Panel */}
            <div
                className={`bg-gray-900 border-b border-gray-800 overflow-hidden transition-all duration-300 ${showInfo ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
                    }`}
            >
                <div className="px-4 py-4">
                    <div className="flex justify-between items-start mb-4">
                        <div className="flex flex-col items-center">
                            ...
                            <h3 className="font-bold text-white">{matchData.name}</h3>
                        </div>

                        <div className="text-center">
                            <div className="font-bold text-2xl text-[#FF6B9D]">{matchData.matchPercentage}%</div>
                            <div className="text-sm text-gray-400">Match</div>
                        </div>

                        <div className="text-center">
                            <div className="font-medium text-white">{matchData.matchDate}</div>
                            <div className="text-sm text-gray-400">Matched on</div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center gap-4 mt-4">
                        ...
                        <button className="px-4 py-2 rounded-lg border border-[#FF6B9D] text-[#FF6B9D] hover:bg-[#FF6B9D]/10 transition-colors">
                            Unmatch
                        </button>
                    </div>
                </div>
            ...
            <div className="flex-grow overflow-y-auto p-4 pb-20">
                <div className="max-w-3xl mx-auto space-y-6">
                    <div className="text-center">
                        <div className="bg-gray-800/50 backdrop-blur-sm inline-block px-4 py-2 rounded-lg text-sm text-gray-400">
                                ...
                                >
                                    ...
                                    <div
                                        className={`max-w-[75%] ${message.senderId === 'user'
                                            ? 'bg-[#FF6B9D] text-white rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl'
                                            : 'bg-gray-800 text-white rounded-tl-2xl rounded-tr-2xl rounded-br-2xl'
                                            } p-3 shadow-lg relative`}
                                    >
                        ...
                        <div className="mt-4 overflow-x-auto scrollbar-hide py-2">
                            <div className="flex space-x-2 w-max">
                                {quickReplies.map((reply, index) => (
                                    <button
                                        key={index}
                                        className="bg-gray-800 border border-gray-700 rounded-full px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 whitespace-nowrap transition-colors"
            ...
            {/* Input */}
            <div className="bg-gray-900 border-t border-gray-800 py-3 px-4 sticky bottom-0 z-40">
                <div className="max-w-3xl mx-auto">
                    <div className="flex items-center">
                        ...
                        <div className="flex-grow mx-2 bg-gray-800 rounded-full flex items-center border border-gray-700">
                            <input
                                type="text"
                                placeholder="Type a message..."
                                className="flex-grow px-4 py-2.5 bg-transparent focus:outline-none text-white placeholder-gray-500"
                                value={messageInput}
                        ...
                        {messageInput ? (
                            <button
                                className="p-2 text-[#FF6B9D] hover:text-[#FF4D88] transition-colors"
