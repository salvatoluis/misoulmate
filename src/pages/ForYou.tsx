            ...
            <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md z-40 shadow-sm border-b border-gray-100 py-4">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            className={`p-2 rounded-full ${filters.showFilters ? 'bg-primary/10 text-primary' : 'bg-gray-100 text-gray-600'}`}
                                    ...
                                    >
                                        <div className="relative aspect-[4/5] overflow-hidden">
                                            ...
                                            {recommendation.hasLikedYou && (
                                                <div className="absolute top-3 left-3 bg-gradient-to-r from-purple-500 to-primary text-white px-2.5 py-1 rounded-full text-xs font-medium shadow-md flex items-center gap-1">
                                        ...
                                        <div className="p-4">
                                            ...
                                            <div className="flex justify-between mt-4 pt-3 border-t border-gray-100">
                                                ...
                                                <button
                                                    className="w-16 h-12 flex items-center justify-center rounded-xl bg-primary hover:bg-primary text-white transition-colors"
