...
const DatePlanner: React.FC = () => {
  const [activeTab, setActiveTab] = useState<"ideas" | "saved" | "custom">(
    "ideas"
  );
  ...
  const matches = [
    {
      ...
      name: "Jordan",
      avatarUrl:
        "https://images.unsplash.com/photo-1527203561188-dae1bc1a417f?w=150&h=150&fit=crop",
    },
    {
      id: "2",
      name: "Taylor",
    ...
    },
    {
      ...
      name: "Alex",
      avatarUrl:
        "https://images.unsplash.com/photo-1503443207922-dff7d543fd0e?w=150&h=150&fit=crop",
    },
    {
      id: "4",
      name: "Casey",
      avatarUrl:
        "https://images.unsplash.com/photo-1573140247632-f8fd74997d5c?w=150&h=150&fit=crop",
    },
  ];
  ...
  const [dateIdeas, setDateIdeas] = useState<DateIdea[]>([
    {
      ...
      description:
        "Get to know each other over artisanal coffee in a relaxed atmosphere.",
      category: "cafe",
      time: "1-2 hours",
      location: "Local coffee shop",
      cost: 1,
      imageSrc:
        "https://images.unsplash.com/photo-1522683280249-025c6e03d311?w=600&h=400&fit=crop",
      liked: false,
    },
    {
      id: "2",
      title: "Sunset Picnic",
      description:
        "Enjoy a scenic picnic with snacks and drinks as the sun sets.",
      category: "outdoors",
      time: "2-3 hours",
    ...
    },
    {
      ...
      description:
        "Listen to live jazz while enjoying craft cocktails in a sophisticated setting.",
      category: "drinks",
      time: "2-3 hours",
      location: "Jazz bar",
      cost: 2,
    ...
    },
    {
      ...
      description:
        "Explore contemporary art exhibits and discuss your impressions.",
      category: "cultural",
      time: "1-2 hours",
    ...
    },
    {
      ...
      description:
        "Indulge in a chef-curated tasting menu at an upscale restaurant.",
      category: "restaurant",
      time: "2-3 hours",
  ...
  const renderCost = (cost: 1 | 2 | 3) => {
    return (
      <div className="flex items-center">
        <span
          className={`text-xs ${
            cost >= 1 ? "text-[#FF6B81]" : "text-gray-300"
          }`}
        >
          $
        </span>
        <span
          className={`text-xs ${
            cost >= 2 ? "text-[#FF6B81]" : "text-gray-300"
          }`}
        >
          $
        </span>
        <span
          className={`text-xs ${
            cost >= 3 ? "text-[#FF6B81]" : "text-gray-300"
          }`}
        >
          $
        </span>
              ...
              <div className="mb-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  {categories.map((category) => (
                    <button
                      key={category.id}
                      className={`py-2 px-3 rounded-lg text-sm border flex items-center justify-center ${
                      ...
                      <div className="h-40 relative">
                        ...
                        >
                          <Heart
                            size={20}
                            className={
                              idea.liked ? "text-white" : "text-gray-600"
                            }
              ...
              <div className="p-4">
                <div className="mb-4">
                  ...
                  <div className="flex overflow-x-auto pb-2 -mx-1">
                    {matches.map((match) => (
                      <button
                        key={match.id}
                        className={`flex flex-col items-center mx-1 p-2 rounded-lg transition-colors ${
                          matchId === match.id
                ...
                <button
                  className={`w-full py-3 rounded-lg text-white font-medium ${
                    matchId && customDatePlan.trim().length > 0
