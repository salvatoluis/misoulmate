            ...
            case 'welcome':
                return (
                    <div className="text-center py-8 max-w-md mx-auto">
                        ...
                        <h1 className="text-2xl font-bold text-gray-800 mb-3">Welcome to Soulmatify</h1>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                <p className="text-xs text-gray-500 mt-1">You must be 18 years or older to use Soulmatify</p>
                            </div>
