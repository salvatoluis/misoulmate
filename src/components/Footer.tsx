...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-[#2B2B2A] text-white py-10">
            <div className="container mx-auto px-4 md:px-6">
                ...
                >
                    <motion.div variants={itemVariants}>
                        ...
                        >
                            ...
                            <span className="text-[#FF6B81]">Match</span>
                        </motion.div>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <p className="text-gray-400 text-sm">© 2025 HeartMatch. All rights reserved.</p>
