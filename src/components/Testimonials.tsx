    ...
    const testimonials = [
        {
            ...
            quote: 'We matched on Soulmatify in June and were engaged by December. The compatibility algorithm really works! We had so much in common from day one.',
            rating: 5,
            location: 'San Francisco, CA',
            date: 'June 2024',
            fullStory: 'We both swiped right and immediately hit it off. Our first date lasted 6 hours - we just couldn\'t stop talking! Within weeks, we knew this was something special. Soulmatify\'s personality questions really helped match us on values that matter. Four months later, Michael proposed during a weekend trip to Napa. We\'re planning our wedding for next summer!',
        ...
        },
        {
            ...
            quote: 'After trying several dating apps, Soulmatify was the one that finally worked for us. The verified profiles meant we could trust who we were talking to.',
            rating: 5,
            location: 'Chicago, IL',
            date: 'April 2024',
            fullStory: 'We were both tired of dating apps with fake profiles and people not looking for real connections. Soulmatify\'s verification system gave us confidence that we were talking to genuine people. When we matched, the conversation flowed naturally. We met for coffee, which turned into dinner, which turned into the best relationship either of us has ever had. Thank you Soulmatify!',
        ...
        },
        {
            ...
            quote: 'Soulmatify understood our cultural background and values. We connected on a level that other apps never provided. Our families couldn\'t be happier!',
            rating: 5,
            location: 'Seattle, WA',
            date: 'March 2024',
            fullStory: 'As two professionals with traditional families but modern lives, finding the right match was challenging. Soulmatify\'s detailed preferences allowed us to be specific about what mattered to us. When we matched, it felt different from other connections we\'d made online. After three months of dating, we introduced each other to our families, who were thrilled. We\'re now planning our future together.',
            matchRate: 96
        }
    ];
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="text-center mb-16">
                    ...
                    <div className="w-16 h-16 mx-auto mb-6 relative">
                        <div className="absolute inset-0 bg-gradient-to-r from-primary/30 to-teal-500/30 rounded-full blur-md"></div>
                        <div className="absolute inset-0 flex items-center justify-center">
                            <Heart size={24} className="text-primary" fill="rgb(79, 70, 229)" />
                        </div>
                    </div>
                    ...
                    <div className="h-1 w-24 bg-gradient-to-r from-primary to-teal-500 rounded-full mx-auto mb-6" />

                    <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                        Hear from couples who found each other through Soulmatify.
                    </p>
                </div>
                ...
                <div className="max-w-6xl mx-auto relative">
                    {/* Large quote mark */}
                    <div className="absolute -top-10 -left-4 md:-left-10 text-[80px] md:text-[120px] text-primary/10 z-0 pointer-events-none">
                        <Quote size="100%" />
                    </div>
                                    ...
                                    <div className="md:col-span-2 flex flex-col">
                                        <div className="relative rounded-2xl overflow-hidden h-48 md:h-full mb-4 md:mb-0">
                                            ...
                                            {testimonials[activeIndex].matchRate && (
                                                <div className="absolute top-4 right-4 bg-gradient-to-r from-primary to-primary text-white px-3 py-1 rounded-full text-sm font-medium flex items-center z-20">
                        ...
                        {testimonials.map((_, index) => (
                            <button
                                ...
                                className={`w-3 h-3 rounded-full ${index === activeIndex
                                    ? 'bg-gradient-to-r from-primary to-primary w-8'
                                    : 'bg-slate-300'
