...
const AIAssistantModal: React.FC = () => {
            ...
            case 'conversation':
                return (
                    <div className="p-4">
                        ...
                        <button className="mt-4 bg-primary hover:bg-primary text-white py-2 px-4 rounded-full text-sm font-medium w-full transition-colors duration-200">
                ...
                return (
                    <div className="p-4">
                        ...
                        <div className="bg-green-50 p-3 rounded-lg mb-3">
                            <h4 className="font-semibold text-primary">What's Working Well</h4>
                        ...
                        <div className="bg-green-50 p-3 rounded-lg mb-3">
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                                {['Hiking', 'Photography', 'Asian Cuisine', 'Jazz'].map(interest => (
                                    <span key={interest} className="px-2 py-1 bg-green-100 text-primary rounded-full text-xs">
                                        {interest}
                                    </span>
                                ))}
                            </div>
    ...
    return (
        <>
            ...
            <button
                onClick={toggleModal}
                className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-to-tr from-primary to-primary shadow-lg flex items-center justify-center text-white hover:shadow-xl transition-shadow duration-300"
            >
            ...
            {isOpen && (
                <div className="fixed bottom-24 right-6 z-50 w-80 bg-white rounded-xl shadow-xl overflow-hidden">
                    {/* Header */}
                    <div className="bg-gradient-to-r from-primary to-primary p-4 text-white">
                    ...
                    {activeFeature ? (
                        ...
                        <div className="divide-y max-h-96 overflow-y-auto">
                            {features.map(feature => (
                                ...
                                >
                                    <div className="bg-green-100 text-primary p-2 rounded-lg mr-3">
                                        {feature.icon}
                                    </div>
                                    <div>
