...
const AIAssistantModal: React.FC = () => {
    ...
    const renderFeatureContent = (featureId: string | null): JSX.Element | null => {
        switch (featureId) {
            case 'conversation':
                return (
                    <div className="p-4">
                        ...
                        <button className="mt-4 bg-pink-600 text-white py-2 px-4 rounded-full text-sm font-medium w-full">
                        ...
                        <div className="space-y-3">
                            <div className="bg-pink-50 p-3 rounded-lg flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">Learn to make pasta together at Maria's Cooking Studio</p>
                                </div>
                            </div>
                            <div className="bg-pink-50 p-3 rounded-lg flex items-start">
                                <img
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">Explore exotic flowers and have tea at the garden café</p>
                                </div>
                            </div>
                        </div>
                        <button className="mt-4 bg-pink-600 text-white py-2 px-4 rounded-full text-sm font-medium w-full">
                ...
                return (
                    <div className="p-4">
                        ...
                        <div className="bg-pink-50 p-3 rounded-lg mb-3">
                            <h4 className="font-semibold text-pink-600">What's Working Well</h4>
                        ...
                        <div className="bg-pink-50 p-3 rounded-lg">
                            <h4 className="font-semibold text-pink-600">Suggestions</h4>
                            <ul className="mt-2 space-y-1 text-sm">
                    ...
                    <div className="p-4">
                        ...
                        <div className="flex justify-between items-center mb-4">
                            <div className="flex items-center">
                                ...
                                />
                                <div className="w-24 h-2 bg-pink-200 mx-2">
                                    <div className="w-20 h-2 bg-pink-500"></div>
                                </div>
                                <img
                            ...
                            <span className="text-xl font-bold text-pink-600">86%</span>
                        </div>
                        <div className="bg-pink-50 p-3 rounded-lg mb-3">
                            <h4 className="font-semibold">Shared Interests</h4>
                            <div className="flex flex-wrap gap-2 mt-2">
                                {['Hiking', 'Photography', 'Asian Cuisine', 'Jazz'].map(interest => (
                                    <span key={interest} className="px-2 py-1 bg-pink-100 text-pink-600 rounded-full text-xs">
                                        {interest}
                                    </span>
                                ))}
                            </div>
    ...
    return (
        <>
            ...
            <button
                onClick={toggleModal}
                className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-to-tr from-pink-500 to-pink-600 shadow-lg flex items-center justify-center text-white"
            >
                ...
                <div className="fixed bottom-24 right-6 z-50 w-80 bg-white rounded-xl shadow-xl overflow-hidden">
                    ...
                    {activeFeature ? (
                        ...
                        <div className="divide-y max-h-96 overflow-y-auto">
                            {features.map(feature => (
                                <button
                                    key={feature.id}
                                    className="w-full p-4 text-left flex items-start hover:bg-pink-50 transition-colors"
                                ...
                                >
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-auto text-gray-400">
                    ...
                    <div className="p-3 bg-gray-50 border-t text-center text-xs text-gray-500">
                        <div className="flex items-center justify-center">
                            <Zap size={12} className="text-pink-500 mr-1" />
